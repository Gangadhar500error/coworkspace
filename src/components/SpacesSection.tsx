...
export default function SpacesSection() {
  return (
    <section className="relative w-full bg-white py-5 lg:py-10 overflow-hidden">
      <div className="container-custom relative z-10 px-4 md:px-6 lg:px-8">
        {/* Section Heading */}
        <div className="text-center mb-10">
          <h2 className="text-xl lg:text-5xl font-bold text-gray-900 leading-tight font-display inline-block">
            ...
            >
              ...
              <div className="relative w-full h-48 md:h-56 lg:h-64">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6">
                  <h3 className="text-lg lg:text-2xl font-bold text-white mb-1.5 font-display">
                    {space.city}
                  </h3>
                  <p className="text-sm md:text-base text-white/95 font-body">
                    {space.subtitle}
                  </p>
                </div>
              </div>
