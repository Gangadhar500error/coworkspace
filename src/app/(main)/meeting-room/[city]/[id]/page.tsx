    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Meeting Room Not Found</h1>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container-custom px-4 sm:px-6 lg:px-8 py-4">
          ...
          >
            ...
            <span>Back to {formattedCity} meeting rooms</span>
          </button>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                {workspace.description && (
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3 font-display">About this meeting room</h3>
                ...
                {/* Amenities */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 font-display">Room Amenities & Features</h3>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl p-6 shadow-sm sticky top-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 font-display">Book This Room</h3>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <textarea
                      rows={3}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-body"
                      placeholder="Any special AV requirements or setup needs..."
                    />
                  </div>
                </div>
