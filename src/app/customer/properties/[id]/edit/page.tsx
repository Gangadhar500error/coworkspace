...
export default function CustomerEditPropertyPage() {
  ...
  useEffect(() => {
    ...
    if (propertyIdParam) {
      const property = customerProperties.find((p) => p.id === parseInt(propertyIdParam));
      if (property) {
        ...
        setFormData({
          ...
          available24x7: property.available24x7 ? "yes" : "no",
          contactPersonName: property.contactPersonName || "",
          phoneNumber: property.contactPhone || "",
          emailId: property.contactEmail || "",
          gstRegistered: "no",
          gstNumber: "",
          wifi: property.amenities?.includes("Wi-Fi") ? "yes" : "no",
          acNonAc: property.amenities?.includes("AC") ? "ac" : "",
          powerBackup: "no",
          lift: "no",
          parking: property.amenities?.includes("Parking") ? "yes" : "no",
          securityCctv: "no",
          pantryCafeteria: property.amenities?.includes("Pantry") ? "yes" : "no",
          totalSeats: property.seats?.toString() || "",
          hotDesksCount: "",
          dedicatedDesksCount: "",
          dailyPrice: property.pricing?.daily?.toString() || "",
          weeklyPrice: property.pricing?.weekly?.toString() || "",
          monthlyPrice: property.pricing?.monthly?.toString() || "",
          minimumBookingDuration: "",
          officeSizes: [],
          numberOfCabins: "",
          privateOfficeMonthlyRent: "",
          ...
          privateAccess: "no",
          roomName: "",
          seatingCapacity: property.seats?.toString() || "",
          roomLayout: "",
          hourlyPrice: property.pricing?.hourly?.toString() || "",
          halfDayPrice: property.pricing?.halfDay?.toString() || "",
          fullDayPrice: property.pricing?.fullDay?.toString() || "",
          projectorTv: property.amenities?.includes("Projector") ? "yes" : "no",
          whiteboard: property.amenities?.includes("Whiteboard") ? "yes" : "no",
          videoConferencing: property.amenities?.includes("Video Conferencing") ? "yes" : "no",
          businessAddress: "",
          virtualOfficeCity: property.city || "",
          addressProofProvided: "no",
          gstRegistrationSupport: "no",
          mailHandling: "no",
