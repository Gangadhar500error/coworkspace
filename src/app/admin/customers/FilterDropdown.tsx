                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {filters.propertyId && (
                        ...
                        >
                          Property: {properties.find(p => p.id.toString() === filters.propertyId)?.name || filters.propertyId}
                          <button
                            onClick={() => onFilterChange("propertyId", "")}
                            className="hover:opacity-70 transition-opacity"
